...
restarts and reloads. Reviewed by hand: single head (b5c7d9e1f3a5, confirmed via `alembic heads`,
not a regex), clean down_revision, no destructive operation, FK cascade to strategies.
"""
