...
PACKAGES = {
    "mr002-n1-execution-evidence": {
        "dir": REPO / ".mr002out" / "n1",
        "notes": ("MR-002 Gate N1 FORMAL execution evidence, produced from pushed commit "
                  f"{SOURCE_COMMIT} in mr002-research:v1.4 under the registered FROZEN_THREAD_ENV. "
                  "Corpus hash 1d2319301a7b52dfe369819bc8029f7b6d64ad820d828f041eba15a91348390b."),
    },
    "mr002-n1-provisional-execution": {
        "dir": REPO / ".mr002out" / "n1_provisional",
        "notes": ("PROVISIONAL_N1_EXECUTION — superseded. Produced 2026-08-19 from UNCOMMITTED code "
                  "before the D1/D3 adjudication and the Condition-8 baseline ruling. Retained as "
                  "engineering evidence, NOT the formal N1 execution. Its bakeoff-population "
                  "equivalence result (3892 trivial + 3 by bound, zero unproven) remains valid, "
                  "scoped evidence by owner ruling."),
    },
}
