...
Requirement 2 of the v3.2 rebind qualification is that the bound code archive REPRODUCES from Git.
This is that reproduction, runnable by anyone with the repository:

    python docs/review/mr002/phase3bc/_gen_v32_rebind_archive.py [--out code_v32.tar.gz]
...
Expected, for checkpoint 899d6456cfa4b3ddcbbaa2c5b64628ff9d6a0240:
    code_identity  487c7f8ddad1904b725747ef37c1b963f5283f887f0d4d9b5c6ba2be2c0b7c34
    archive        6b75daf6549bbaf2efeb049a9087ea5b3c807623e10246956b13142afb69f4f1
"""
...
CHECKPOINT = "899d6456cfa4b3ddcbbaa2c5b64628ff9d6a0240"
EXPECT_CODE_IDENTITY = "487c7f8ddad1904b725747ef37c1b963f5283f887f0d4d9b5c6ba2be2c0b7c34"
EXPECT_ARCHIVE = "6b75daf6549bbaf2efeb049a9087ea5b3c807623e10246956b13142afb69f4f1"

HERE = os.path.dirname(os.path.abspath(__file__))
REPO = os.path.abspath(os.path.join(HERE, "..", "..", "..", ".."))
# The accepted v3.1 closure defines the member set; v3.2 rebinds the same set at a new checkpoint.
