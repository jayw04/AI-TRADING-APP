# TradingWorkbench — Research Program Registry (v0.16)
...
| Indicator | Value |
|---|---|
| Programs chartered | **11** (8 strategy + 1 external-import [TV-001] + 1 platform capability [SCAN-001] + 1 portfolio-engineering [FI-001]) + **2 not-yet-run** (FI-002 Correlation Stability *reserved* · FI-003 Tail-Hedge Overlay Validation *planned*) |
| Research verdicts | Approved **1** · Diversifier **3** · Inconclusive **1** · Rejected **4** (RNG-001 · MOM-002 · INSIDER-001 · TV-001) · Planned/Pending/Reserved **3** (TREND-001 · FI-002 · FI-003) · Validated capability **1** · *capability-level Rejected* **1** (CAP-020) |
...
| Preserved negative / null findings | **7** — RNG-001 rejection · MOM-002 rejection (reshaping a validated book — breadth & sector cap both declined) · SCAN-001 v0.1 ATR-tautology self-catch · SCAN-001 v0.4 confidence-uninformative · INSIDER-001 rejection (beta-not-alpha) · CAP-020 rejection (regime overlay not a Calmar/return improver — survivorship-free confirmed) · TV-001-SUPERTREND rejection (community-strategy candidate fails generalization/parameter-stability/cost) |
| Evidence generated | **Positive 4** (MOM-001 · SCAN-001 · LOW-001 · SEC-001) · **Negative 7** (RNG-001 · MOM-002 · INSIDER-001 · CAP-020 · TV-001 · SCAN v0.1 · SCAN v0.4) · **Neutral 1** (MF-001) — *negative evidence is productive: it is the majority of the record and the platform's differentiator* |
