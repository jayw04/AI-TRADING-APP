# TradingWorkbench — Research Program Registry (v0.17)
...
| Indicator | Value |
|---|---|
| Programs chartered | **14** (8 strategy + 1 external-import [TV-001] + 1 platform capability [SCAN-001] + 1 portfolio-engineering [FI-001] + **3 EAD event-driven** [GOVCONTRACT-001 · CONGRESS-001 · LOBBY-001]) + **2 not-yet-run** (FI-002 Correlation Stability *reserved* · FI-003 Tail-Hedge Overlay Validation *planned*); EAD reserved: LOBBY-002 · OFX-001 |
| Research verdicts | Approved **1** · Diversifier **3** · Inconclusive **1** · Rejected **7** (RNG-001 · MOM-002 · INSIDER-001 · TV-001 · **GOVCONTRACT-001 · CONGRESS-001 · LOBBY-001**) · Planned/Pending/Reserved **3** (TREND-001 · FI-002 · FI-003) · Validated capability **1** · *capability-level Rejected* **1** (CAP-020) |
...
| Platform capabilities catalogued | **23** (CAP-001 … CAP-023, below) |
