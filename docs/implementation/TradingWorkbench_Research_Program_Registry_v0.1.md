...
| Research verdicts | Approved **1** · Diversifier **2** · Inconclusive **1** · Rejected **3** · Planned/Pending **2** · Validated capability **1** |
...
| **FI-001** 🧩 | Multi-Factor Interaction & Portfolio Engineering — **how validated factors interact & combine** | **Planning** (charter frozen) | `█░░░░░░░░░` 10% | Open (Phase 1 next) | — **Pending** | **Portfolio Engineering** — the bridge from Discovery Lab (validating factors) to combining them into robust books; today's Combined Book is one output |
