...
a 21-file governed Amendment because production had falsified the declaration-only model. **B-1 has not
started.**
...
|---|---|---|
| **K1**, **K3** | yes | the deterministic path — **calculators do not exist** |
