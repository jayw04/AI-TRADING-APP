# Algo Trader Plus / Strategy Proposals v1.4.1 --- Final Design & Implementation Plan
  ...
  Field                               Value
  ----------------------------------- ----------------------------------------------------------------------
  **Document version**                **v1.0.2 --- state/procedure-surface sync (v1.0.1 review findings applied)**
  ...
  **Canonical repository path**       `docs/design/ATP/AlgoTraderPlus_v1_4_1_ImplementationPlan_v1_0_2.md`
  ...
  **Supersedes**                      v1.0 for current-state execution guidance. v1.0.2 incorporates the
                                      unlanded v1.0.1 review/update findings; v1.0.1 was not separately
                                      placed in repository custody and is not a governing predecessor. v1.0
...
These are explicit gates, not developer TODOs to resolve by inference:
  ...
  **G3 expected-disposition           **OPEN --- must be recorded BEFORE
  recording** *(added v1.0.2)*        any K value is computed.** Owner
                                      prospectively records that
                                      HOLD-with-stated-extension or STOP
                                      is the expected G3 outcome of the
                                      profitability allocation decision
                                      (§6.1); changes no criterion. If
                                      left unrecorded until K values
                                      exist, the record loses its
                                      prospective character permanently.
