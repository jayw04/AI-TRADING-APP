...
sys.path.insert(0, "/opt/canary2/site")
sys.path.insert(0, "/opt/canary2/apps/backend")
...
out = {
    ...
    "implementation_commit": "517cab0fe28b03cc28d3929a932c6855e3967dc2",
    "accession": ACCESSION,
    "url": URL,
...
with open("/opt/canary2/canary_result.json", "w") as fh:
