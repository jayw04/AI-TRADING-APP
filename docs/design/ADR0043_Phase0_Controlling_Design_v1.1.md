...
| 2 | WP1–WP4 | As v1.0, under this controlling design |
| 3 | **CORR-06** account isolation | Own numbered package + exit gate; after WP4, before O1/O2 |
| 4 | WP5–WP9 | Dataset / model / gates; WP5 carries statistical-design freeze |
