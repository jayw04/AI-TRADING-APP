...
Last updated: 2026-05-26 · branch: `main` · latest tag: `p4-param-form-complete`
...
| **§3, §4, §6, §8** | Opportunities page, hot reload, backtest charting, WS bar dispatch (doc files exist) | ⏳ |
